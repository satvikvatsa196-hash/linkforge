...
interface UrlRepository : JpaRepository<Url, Long> {
    ...
    @org.springframework.data.jpa.repository.Query(
        value = "INSERT INTO urls (id, original_url, short_code, created_at, updated_at, clicks_count) VALUES (:id, :originalUrl, :shortCode, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)",
        nativeQuery = true
    )
    fun insertUrlWithId(
